...
public:
	...
	string get_newname() const {
		return newname;
	}
	void set_newemail() {
		getline(cin, newemail);
	}
	string get_newemail()const {
		return newemail;
	}
	void set_fathername() {
	...
	string get_newaddress() const {
		return newaddress;
	}
	void set_newphone() {
		getline(cin, newphone);
	}
	string get_newphone() const {
		return newphone;
	}
	void set_newaccno() {
		cin >> newaccno;
	}
	double get_newaccno()const {
		return newaccno;
	}
	void set_newbalance() {
		cin >> newbalance;
	}
	double get_newbalance() const {
		return newbalance;
	}
	void set_cnic() {
		getline(cin, cnic);
...
public:
	...
	void depositamount() {//pollymorphism
		double depositamount;
		cout << "\n\nEnter the Deposit Amount To Add In Your Current Account:";
		cin >> depositamount;
		cout << "\n\n\nThe Total Balance In Your Current Account Is:" << get_newbalance() +
			depositamount << endl;
	}
	void withdrawamount() {
		double withdrawamount;
		cout << "\n\nEnter the Withdraw Amount To Add In Your Current Account:";
		cin >> withdrawamount;
		cout << "\n\n\nThe Total Balance In Your Current Account Is:" << get_newbalance() -
			withdrawamount << endl;
	}
...
public:
	...
	void showmanagerdata(const Person obj)
	{
		system("cls");
